...
\begin{frame}
    ...
    Abbiamo analizzato in dettaglio la sua interfaccia e abbiamo rinvenuto diverse criticità; di seguito verranno dettagliate, ora possono essere riassunte in:
    \begin{itemize}
